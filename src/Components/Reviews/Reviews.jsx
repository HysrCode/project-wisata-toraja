...
import person6 from "../../Assets/review/download.jfif"
        ...
        <div className="review section container">
            <div className="secContainer grid">
                <div className="textDiv">
                    ...
                    <p>By Chooising us as their tour agency, cosutmers can expect an enchiring and enjoyable travel experience, filled width unforgetable memories that will last a lifetiime</p>
